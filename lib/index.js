    ...
    if (nodeArgs.length <= 2) {
        ...
        switch (userChoice) {
            ...
            case "do-what-it-says":
                ...
                break;
            default:
                console.log("Sorry - I didn't understand that. Please enter one of the commands\n node index.js concert-this <artist/band name here> \n node index.js spotify-this-song <song name here> \n node index.js movie-this <movie name here> \n node index.js do-what-it-says");
                break;
        }
    }
}
